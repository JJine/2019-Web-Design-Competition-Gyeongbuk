function button1_click() {
    ...
    let canvas, context, starX, starY, ctx, drawing = false; //context = information 객체의 현재 상태,  
    ...
    function button2_click() {
        ...
        var startX, startY, width, height, drawing =false;
    ...
    //텍스트
    function txt_click() {
        var canvas = document.getContext("myCanvas");
        var ctx = canvas.getContext("2d");
        //사실 var document.getContext("myCanvas").getContext("2d");
        ...
        font_size.onchange = function (e) {
            ctx.font = font_size.value;
        }
